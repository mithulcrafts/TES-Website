...
// IMPORT YOUR TEAM COMPONENT HERE. Adjust the path if necessary!
...
export default function About() {
  ...
  return (
    <>
    <Background />
    <main className="max-w-5xl mx-auto px-6 py-24 w-full flex flex-col gap-24 relative z-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="md:col-span-1 border-t-2 border-[var(--color-sapphire)] pt-4">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-[var(--color-text-main)] uppercase">
            About
          </h2>
        </div>
        <div className="md:col-span-3 text-lg md:text-xl font-medium text-[var(--color-text-muted)] leading-relaxed space-y-4">
          <p>
      ...
      {/* 3. Core Principles */}
      <section className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="md:col-span-1 border-t-2 border-[var(--color-teal)] pt-4">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-[var(--color-text-main)] uppercase">
            Core Principles
          </h2>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="md:col-span-1 border-t-2 border-[var(--color-lavender)] pt-4">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-[var(--color-text-main)] uppercase leading-tight">
            Peer Learning
          </h2>
        </div>
        <div className="md:col-span-3 text-lg md:text-xl font-medium text-[var(--color-text-muted)] leading-relaxed space-y-4">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="md:col-span-1 border-t-2 border-[var(--color-flamingo)] pt-4">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-[var(--color-text-main)] uppercase leading-tight">
            Contributions
          </h2>
        </div>
